...
file_td = file('mixParsed.txt', 'r')    # training data
file_rn = file('rightNgram.txt', 'r')   # right bigram
file_wn = file('wrongNgram.txt', 'r')   # wrong bigram
file_pb = file('train_prob.txt', 'w')   # output probability
